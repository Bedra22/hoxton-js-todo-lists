const users = [
  ...
  for(let user of users){
    message += ("The user Id is"+user.id + ", the name of the user is" + user.username+" and the city they are from is" + user.address.city )
  }
  alert(message)

  let chooseanID=Number(prompt("Choose the ID you want:"))
  console.log(chooseanID)
  for (let user of users){
    if(chooseanID===user.id)
    {
        console.log("The username is "+user.username)
    }
  }
  for (let todo of todos){
    if(chooseanID===todo.userId)
    {
